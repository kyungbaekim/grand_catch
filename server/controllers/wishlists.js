...
module.exports = {
  ...
  create: function(req, res) {
    ...
    User.findOne({_id: req.params.id}, function(err, user){
      var wishlist = new Wishlist({seller: req.body.seller, product_name: req.body.product_name, product_id: req.body.product_id, product_url: req.body.product_url, product_img_url: req.body.product_img_url, _user: user._id});
